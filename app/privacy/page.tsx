export const metadata = {
  ...
  description: "Privacy Policy for JobNest Urdaneta City (English and Filipino versions)."
};
...
export default function Page() {
  return (
    <main className="max-w-3xl mx-auto px-6 py-10 prose prose-slate">
      ...
      <h2 className="mt-8 text-xl font-bold">English</h2>
      <pre className="whitespace-pre-wrap text-sm">PRIVACY POLICY
...
Email: support@jobnest.mysdproject2025.com</pre>

      <h2 className="mt-8 text-xl font-bold">Filipino (Tagalog)</h2>
      <pre className="whitespace-pre-wrap text-sm">PATAKARAN SA PRIBADONG IMPORMASYON (PRIVACY POLICY)
...
Email: support@jobnest.mysdproject2025.com</pre>
      ...
      <div className="mt-10 text-xs text-slate-500">
        Address: Urdaneta City, Pangasinan, Philippines · Contact: support@jobnest.mysdproject2025.com
      </div>
    </main>
  )
}
