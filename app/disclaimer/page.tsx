...
export default function Disclaimer({
  ...
  const en = readLegal('disclaimer_en.txt');
  const fil = readLegal('disclaimer_fil.txt');
  const body = selected === 'fil' ? fil : en;

  return (
    <div className="max-w-4xl mx-auto px-4 py-10">
      <h1 className="text-2xl md:text-3xl font-extrabold text-brandNavy">Disclaimer</h1>
